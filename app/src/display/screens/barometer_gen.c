...
lv_obj_t * barometer_create(void)
{
    ...
    if (display_check_target(DISPLAY_TARGET_ALL)) {
        ...
        lv_obj_set_style_pad_top(lv_obj_7, 4, 0);
        lv_obj_t * lv_label_4 = lv_label_create(lv_obj_7);
        lv_label_set_text(lv_label_4, "PRESSURE TREND");
        lv_obj_add_style(lv_label_4, &label_xs, 0);

        lv_obj_t * lv_label_5 = lv_label_create(lv_obj_7);
        lv_label_bind_text(lv_label_5, &press_trend, NULL);
        lv_obj_add_style(lv_label_5, &pill, 0);
